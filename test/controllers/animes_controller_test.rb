...
class AnimesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create anime" do
    assert_difference("Anime.count") do
      post animes_url, params: { anime: { main_character: @anime.main_character, title: @anime.title, year_created: @anime.year_created } }
    end
  ...
  test "should update anime" do
    patch anime_url(@anime), params: { anime: { main_character: @anime.main_character, title: @anime.title, year_created: @anime.year_created } }
